...
目标：学会阅读、修改、发布和验证 SignalFoundry Skills，并理解 skill 如何影响生成页面质量。
...
Skill 可以理解成 Agent 的本地专业手册。模型本身有通用能力，但它不知道 SignalFoundry 当前有哪些数据文件、验证规则、页面模板、禁止事项和数据源边界。Skill 把这些项目规则写下来，让 Agent 在生成时遵守。
