...
const sourcePath = path.join(root, 'public', 'signalfoundry-mark.svg');
const targets = [
  ...
  { size: 192, path: 'public/icons/signalfoundry-192.png' },
  { size: 512, path: 'public/icons/signalfoundry-512.png' },
  { size: 512, path: 'public/SignalFoundry_Icon.png' },
];
...
async function main() {
  ...
  console.log(`[brand-icons] generated ${targets.length} assets from public/signalfoundry-mark.svg`);
}
