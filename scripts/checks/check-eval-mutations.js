...
const rawThreshold = thresholdArg
  ...
  : thresholdIndex >= 0 ? process.argv[thresholdIndex + 1] : process.env.SIGNALFOUNDRY_EVAL_MIN_MUTATION_KILL_RATE || '100';
...
const catalogPath = path.resolve('benchmarks/signalfoundry/mutation-catalog.json');
...
const outputDir = path.resolve('tmp/signalfoundry-eval-mutations');
