...
const port = Number.parseInt(process.env.PORT || process.env.SIGNALFOUNDRY_CONTRACT_MARKET_PORT || '8000', 10);
const host = process.env.SIGNALFOUNDRY_CONTRACT_MARKET_HOST || '127.0.0.1';
