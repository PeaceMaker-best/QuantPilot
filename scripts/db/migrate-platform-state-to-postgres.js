...
const EVAL_REPORTS_DIR = path.join(ROOT, 'tmp', 'signalfoundry-benchmark-reports');
const EVAL_QUEUE_PATH = path.join(ROOT, 'tmp', 'signalfoundry-eval-queue', 'queue.json');
const EVAL_SCHEDULE_PATH = path.join(ROOT, 'tmp', 'signalfoundry-eval-queue', 'schedule.json');
const EVAL_REPAIRS_PATH = path.join(ROOT, 'tmp', 'signalfoundry-eval-repairs', 'repairs.json');
