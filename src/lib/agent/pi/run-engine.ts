...
/**
 * The PI packages are ESM-only. SignalFoundry's standalone Worker entry is
...
/**
 * PI owns the complete multi-turn agent loop and calls the real SignalFoundry
 * tools. SignalFoundry remains the host governance layer for approval, durable
