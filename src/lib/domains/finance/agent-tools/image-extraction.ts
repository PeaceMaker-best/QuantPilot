...
export function createImageExtractionTool(
  ...
  return {
    ...
    description:
      'Read SignalFoundry uploaded-image attachments, verify the files inside the PI Agent workspace, and return the portfolio screenshot metadata/extraction contract. This tool performs no OCR and never invents uncertain fields.',
    effect: 'read',
