...
const DEFAULT_WEBHOOK_ENV: Record<string, string> = {
  wxwork: 'SIGNALFOUNDRY_WXWORK_RESEARCH_WEBHOOK',
  feishu: 'SIGNALFOUNDRY_FEISHU_RESEARCH_WEBHOOK',
  dingtalk: 'SIGNALFOUNDRY_DINGTALK_RESEARCH_WEBHOOK',
  discord: 'SIGNALFOUNDRY_DISCORD_RESEARCH_WEBHOOK',
};
