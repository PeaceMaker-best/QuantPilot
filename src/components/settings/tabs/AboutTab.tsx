  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        ...
        <h3 className="text-2xl font-bold text-slate-900">QuantScope</h3>
      ...
      <div className="space-y-4 rounded-xl border border-slate-200 bg-slate-50 p-6">
        <div className="text-center">
          <p className="mx-auto max-w-2xl text-base leading-relaxed text-slate-700">
            QuantScope 是面向量化研发的 AI 工作台，通过开源 PI Agent 与 ModelPort 使用本地 Qwen、
      ...
      <div className="text-center">
        <div className="flex justify-center gap-6">
          <a
            href="https://github.com/PeaceMaker-best/QuantScope"
            target="_blank"
