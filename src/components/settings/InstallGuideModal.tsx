...
function InstallGuideModal({ onClose, onRefreshStatus, onCopyToast }: InstallGuideModalProps) {
  ...
  const steps = [
    ...
    { title: "配置 AetherGateway 客户端凭据", command: "AETHERGATEWAY_API_KEY=..." },
    { title: "重新启动 SignalFoundry", command: "npm run dev" },
  ];
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-600">默认通过 AetherGateway 使用 Qwen 与 DeepSeek，官方直连保持可选。</p>
              </div>
            </div>
