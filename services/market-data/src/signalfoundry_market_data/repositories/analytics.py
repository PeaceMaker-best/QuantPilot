...
from signalfoundry_market_data.contracts.analytics import ClickHouseSyncResponse
from signalfoundry_market_data.database_core import connect
    ...
    *,
    ...
    if not is_clickhouse_enabled():
        return ClickHouseSyncResponse(
            ...
            message="ClickHouse 分析层未启用，设置 SIGNALFOUNDRY_CLICKHOUSE_ENABLED=1 后可同步。",
        )
