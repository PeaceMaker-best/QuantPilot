...
from signalfoundry_market_data.clickhouse import is_clickhouse_enabled
from signalfoundry_market_data.contracts.foundation import DataProviderInfo, DataRegistryResponse
...
def build_data_providers(ttls: ProviderRegistryTtls) -> list[DataProviderInfo]:
    return [
        DataProviderInfo(
            id="signalfoundry-analysis-context",
        ...
        DataProviderInfo(
            id="signalfoundry-research-universe",
        ...
        DataProviderInfo(
            id="signalfoundry-a-share-screener",
        ...
        DataProviderInfo(
            id="signalfoundry-clickhouse-analytics",
            ...
            cache_ttl_seconds=None,
            limitations=[
                "默认关闭，需要设置 SIGNALFOUNDRY_CLICKHOUSE_ENABLED=1。",
