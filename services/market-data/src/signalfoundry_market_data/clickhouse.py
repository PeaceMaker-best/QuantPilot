...
DEFAULT_DATABASE = "signalfoundry"
...
def clickhouse_config() -> ClickHouseConfig:
    ...
    return ClickHouseConfig(
        enabled=_env_flag("SIGNALFOUNDRY_CLICKHOUSE_ENABLED", False),
        host=host,
        port=port,
        username=os.getenv("CLICKHOUSE_USER", "signalfoundry").strip() or "signalfoundry",
