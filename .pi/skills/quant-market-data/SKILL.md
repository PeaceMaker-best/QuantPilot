...
description: Fetch and validate stock, index, ETF, or A-share market bars and quotes through SignalFoundry's local-first market-data backend. Use for price history, realtime snapshots, liquidity fields, data coverage, or evidence needed by analysis, backtests, and dashboards.
---
