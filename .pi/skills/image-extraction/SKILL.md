...
description: Use this skill whenever a SignalFoundry task includes uploaded images or .data-agent/attachments.json, especially portfolio/account screenshots that need holdings, cost, cash, PnL, and position fields extracted before market data and visualization.
---

# SignalFoundry 图片提取能力
