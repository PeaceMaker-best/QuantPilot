#!/usr/bin/env python3
"""Validate a SignalFoundry query rewrite artifact without network or file writes."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Validate a SignalFoundry finance-query-rewrite.json contract.",
    )
    parser.add_argument(
        "--input",
        required=True,
